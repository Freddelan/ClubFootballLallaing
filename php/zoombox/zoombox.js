...
var zoombox_path = scr[scr.length - 1]
  .getAttribute("src")
  .replace("zoombox.js", "");
...
(function ($) {
  ...
  function gallery() {
    ...
    if (options.gallery) {
      ...
      for (var i in imageset) {
        ...
        var img = $(
          '<img src="' + imgSrc + '" class="video gallery' + i * 1 + '"/>'
        );
      ...
      $("#zoombox .zoombox_gallery")
        .show()
        .animate({ bottom: 0 }, options.duration);
    }

    $("#zoombox").bind("change", function (e, css) {
      if (
        $("#zoombox .zoombox_gallery div").width() <
        $("#zoombox .zoombox_gallery").width
      ) {
        return true;
      }
      var d = 0;
      ...
      var decal =
        -$("#zoombox .zoombox_gallery img.current").data("left") +
        $("#zoombox .zoombox_gallery img.current").width() / 2;
  ...
  function open() {
    ...
    if (options.animation == true) {
      ...
      $("#zoombox .zoombox_container").animate(
        css,
        options.duration,
        function () {
